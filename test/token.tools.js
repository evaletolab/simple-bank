...
describe("Token tools", async function() {
  ...
  it("YPA interest operation in wei/s", () =>{
    ...
    const interest = BigInt(1050.35 * 1e18) * (month) * 3n/year100;
    expect((Number(interest)/1e18).toFixed(6)).eq((1050.35 * (3600 * 24 * 30.5) * 3/3161477400).toFixed(6));
  });
  ...
  it("0.3% fees in wei ", () =>{
    ...
    // console.log('wei   -- 0.3% on 100 wei', chf100 * 3n / 1000n / wei);
    expect((Number(chf100 * 3n / 1000n) / 1e18)).eq(0.003*100)
